...
rule1 = ctrl.Rule((temperature['NB']||temperature['NS']) & soil_humidity['NB'] & (air_humidity['NB']||air_humidity['NS']) & LightIntensity['N'] & Ph['NB'] & CarbonConcen['NB'], water[2] & change_carbonConcen[3] & change_temperature[4] & change_humidity[2] & change_lightIntensity[4])
rule2 = ctrl.Rule((temperature['NS']||temperature['ZE']) & soil_humidity['NB'] & air_humidity['PB'] & LightIntensity['N'] & Ph['NB'] & CarbonConcen['NS'], water[4] & change_carbonConcen[2] & change_temperature[2] & change_humidity[2] & change_lightIntensity[1])
rule3 = ctrl.Rule((temperature['NS']||temperature['ZE']) & soil_humidity['NS'] & air_humidity['PS'] & LightIntensity['Z'] & Ph['NB'] & CarbonConcen['NS'], water[3] & change_carbonConcen[3] & change_temperature[3] & change_humidity[2] & change_lightIntensity[2])
rule4 = ctrl.Rule(temperature['ZE'] & soil_humidity['NB'] & air_humidity['PB'] & LightIntensity['P'] & Ph['NB'] & (CarbonConcen['NB']|| CarbonConcen['NS']), water[1] & change_carbonConcen[3] & change_temperature[1] & change_humidity[2] & change_lightIntensity[2])
